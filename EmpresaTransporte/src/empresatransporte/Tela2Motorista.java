...
public class Tela2Motorista extends javax.swing.JFrame {
     ...
     public double hrtrab;
     public String veiculo;
     public double carga;
     public double salario; 
     public double valorhr=15;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Caminhão", "Carro" }));
    ...
    private void btExecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExecutarActionPerformed
        ...
        hrtrab = Double.valueOf(jTextField1.getText());
        veiculo = jComboBox1.getSelectedItem().toString();
        carga = Double.valueOf(jTextField3.getText());
        
        if(hrtrab>=100){
            valorhr = valorhr*1.25;
        }
